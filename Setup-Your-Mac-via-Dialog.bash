...
configurationDownloadEstimation="true"                                          # Do we make an estimate of the download time
...
# ** Moveed to globals configurationDownloadEstimation="true"      # [ true (default) | false ]
